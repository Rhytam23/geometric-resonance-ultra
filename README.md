...
This is a customized version of **Geometric Resonance**, originally created by [Kyler Simzer](https://github.com/kylersimzer/Geometric-Resonance).
...
2.  Open it in a modern browser (Chrome or Edge work best).
...
*Heads up: Browser support for this API varies. If it acts weird on Safari, try Chrome.*
...
And if you dig the modifications in this specific version, a hat tip to this fork is always appreciated too.
